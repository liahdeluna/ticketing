        ...
        <div class="tag-wrapper">
            <div class="number-card number-card-content2">
                <?php
                    ...
                    $query = "SELECT Ticket_Number FROM tickets WHERE Ticket_Type = 'Hardware Concern' AND Ticket_Status = 'Pending' ORDER BY Ticket_Type";
            ...
            <div class="style-label">Number of Tickets with Hardware Concern</div>
        </div>
    </div>
